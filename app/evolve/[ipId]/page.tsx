...
export default function EvolvePage() {
  ...
  const handleEvolveIP = async () => {
    ...
    if (totalPercent !== 100) {
      toast.error("Invalid Contribution Split", {
    ...
    if (!user) {
      toast.error("You must be logged in to evolve an IP.");
      return;
    }

    if (!licenseTermsId) {
      toast.error("Missing License Terms", {
    ...
    toast.loading("Evolving IP on the blockchain...", {
