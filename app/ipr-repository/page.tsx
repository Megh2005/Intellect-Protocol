...
const IprRepositoryPage = () => {
  ...
  const handleFetchIprInfo = async () => {
    ...
    const toastId = toast.loading("Fetching IPR information...");
    setLoading(true);
    setError(null);
    setIprInfo(null);
    try {
      ...
      toast.success("IPR information loaded successfully.", { id: toastId });
    } catch (err: any) {
                  ...
                  <CardContent className="flex-grow flex flex-col">
                    ...
                    >
                      {chatHistory.map((chat, index) => (
                        ...
                        >
                          <div
                            className={`max-w-2xl rounded-lg px-4 py-2 prose prose-invert ${
                              chat.sender === "user"
